...
public class JsonHelper {
	...
	public JSONObject parse(Book book) {
	...
	public JSONObject parse(BookCat bcat) {
		JSONObject obj = new JSONObject();
		if (bcat != null) {
	...
	public JSONObject parse(Comment comm) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(CoverFormat cover) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Menu menu) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Options opt) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Orders order) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(OrderDetail oDetails) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Rate rate) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Role role) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(Token token) {
		JSONObject obj = new JSONObject();
	...
	public JSONObject parse(UserRole uRole) {
		JSONObject obj = new JSONObject();
	...
	public JSONArray parse(List<Book> lstBook) {
