...
public class BookController {
	...
	public @ResponseBody String getByPrice(@PathParam(value = "gte") Float gte, @PathParam(value = "lte") Float lte, @PathParam(value = "from") Integer from, @PathParam(value = "size") Integer size) {
